...
include("header.php"); ?>
  ...
  <div class="embed-responsive embed-responsive-16by9">
    ...
    <div class="video-description bg-light" style="margin-left: 50px;"><!--Videonun sağındaki yazıyı ekliyoruz. -->
      <p>Deadlift, yüklü bir halterin veya çubuğun kalça seviyesine kadar kaldırıldığı, yere geri yerleştirmeden önce gövdenin zemine dik tutulduğu bir ağırlık antrenmanı egzersizidir.</p>
      <p>Bu egzersiz bacakları ve kalçaları birincil olarak kullansa da, aynı zamanda bir sırt egzersizi olarak da düşünülebilir.</p>
      <p>Squat ve bench press ile birlikte üç powerlifting egzersizinden biridir.</p>
    </div>
  </div>

  <div class="footer-icons"> <!--Wikipedia ve youtube linklerini ekliyoruz. -->
    <p>Daha fazla bilgi için:</p>
    <a href="https://tr.wikipedia.org/wiki/Deadlift" target="_blank">
      <img src="wikipedia.png" alt="Wikipedia"  >
    </a>
    <a href="https://www.youtube.com/watch?v=IGaN66dcZEs&ab_channel=EddieHallTheBeast" target="_blank">
